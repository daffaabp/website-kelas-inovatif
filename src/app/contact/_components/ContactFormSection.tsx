                    ...
                    <div className="bg-white dark:bg-contact-surface-dark rounded-2xl p-8 lg:p-12 shadow-lg border border-gray-200 dark:border-gray-800 h-full">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                                ...
                                <button
                                    type="submit"
                                    className="w-full sm:w-auto px-8 py-3 bg-eduzin-dark hover:bg-eduzin-dark/90 text-white rounded-full font-medium transition-all shadow-lg shadow-eduzin-dark/20 inline-flex items-center justify-center gap-2 order-1 sm:order-2"
                                >
                                    Kirim Pesan
